...
window.KmtaPorkEtcApp = (function () {
  ...
  const PIVOT_DIM_LABEL = { item: "\uBD80\uC0B0\uBB3C", year: "\uC5F0\uB3C4" };
  ...
  return function KmtaPorkEtcApp() {
    ...
    const exportPivotXlsx = () => {
      ...
      downloadXlsx([header, ...rows2, footer], `KMTA_돈육_부산물시세_피벗표_${PIVOT_DIM_LABEL[rowDim]}x${PIVOT_DIM_LABEL[colDim]}.xlsx`, "피벗표");
    };
    ...
    return React.createElement("div", { style: { padding: "clamp(14px,4vw,24px) clamp(10px,3vw,16px) 40px", maxWidth: 1040, margin: "0 auto" } },
      ...
      mainTab === "table" && React.createElement("div", { style: { background: COLORS.panel, border: `1px solid ${COLORS.panelBorder}`, borderRadius: 10, padding: 16, marginBottom: 24 } },
        React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center", marginBottom: 12 } },
          React.createElement(HoverAxisPicker, { label: "\uD589", value: rowDim, onChange: onRowDimChange, options: [["item", "\uBD80\uC0B0\uBB3C"], ["year", "\uC5F0\uB3C4"]] }),
          React.createElement(HoverAxisPicker, { label: "\uC5F4", value: colDim, onChange: onColDimChange, options: [["item", "\uBD80\uC0B0\uBB3C"], ["year", "\uC5F0\uB3C4"]] }),
